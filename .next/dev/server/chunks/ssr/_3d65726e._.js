        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: reviews.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    lineNumber: 99,
                    columnNumber: 11
                }, this) : reviews.map((review, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
async function postToApi(endpoint, body) {
    try {
        // 1. Jalankan handshake CSRF
        await getCsrfToken();
        // 2. Ambil token dari localstorage jika ada (untuk otorisasi)
        ...
        const json = await res.json();
        // Memberikan return object yang konsisten untuk Next.js
        return {
            status: res.status,
            ...
            role: json.role,
            user: json.user,
            errors: json.errors // Untuk menangkap validasi error dari Laravel
        };
    } catch (error) {
        console.error(`API Post Error pada ${endpoint}:`, error);
        return {
            success: false,
            message: "Gagal terhubung ke server. Pastikan Backend Laravel menyala."
        };
    }
}
async function loadAllFromDatabase() {
    try {
        // 1. Ambil data kuliner asli dari MySQL lewat API Laravel
        const res = await fetch(`${API_BASE_URL}/culinaries`, {
            cache: "no-store"
        });
        const json = await res.json();
        const dbCulinaries = json.data || [];
        // 2. Load data statis kategori & provinsi dari file lokal Next.js
        ...
        // 3. Mapping data agar cocok dengan properti yang dibutuhkan komponen UI (KulinerCard/Grid)
        ...
        console.error("Load All Master Data Gagal:", error);
        return {
            provKota: {},
            kategori: [],
            kuliner: [],
...
async function loadJSON(path) {
    ...
    if (!res.ok) throw new Error(`Gagal memuat JSON: ${url}`);
    return res.json();
}
}),
...
//# sourceMappingURL=_3d65726e._.js.map